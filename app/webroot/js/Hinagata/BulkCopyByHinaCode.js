...
class BulkCopyByHinaCode{
	...
	*/
	constructor(param){
		...
		if(param == null) param = {};
		if(param.main_slt == null) throw new Error('システムエラー:BulkCopyByHinaCode:2023100209A');
	...
	_createHtml(){
		...
		let html = `
			...
			<div id="bchc_form" style='margin:5px;padding:12px;border-radius:5px;background-color:#ccffcc;display:none'>
				...
				<table>
					<tbody>
						<tr><td>複製元の雛型コード</td><td><input id='bchc_hina_code_orig' type='text' value='' class='form-control' style="width:8em" ></td></tr>
